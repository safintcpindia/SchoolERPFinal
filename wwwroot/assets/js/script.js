	...
	function init() {
		...
		$('.sidebar-menu a').on('click', function(e) {
			...
			if(!$(this).hasClass('subdrop')) {
				// Close all other open submenus that are not ancestors of the clicked item
				$('.sidebar-menu li.submenu > ul').not($(this).parents('ul')).slideUp(250);
				$('.sidebar-menu a.subdrop').not($(this).parents('li').children('a')).removeClass('subdrop');
